<template>
  <div>
            ...
            <div class="flex flex-col">
              <div class="justify-self-start">
                ...
                <p class="text-xl mt-6">
                  If you are looking at blank cassettes on the web, you may be
                  very <br />confused at the difference in price.
                </p>
                <p class="mt-5">
                ...
                <div class="relative">
                  ...
                  >
                    ...
                    <p class="font-bold text-xl mt-4">
                      Smart Kitchen Setup with <br />
                      Vintage Style
                    </p>
                    <p class="mt-8 text-xl">
                      <button type="submit" class="flex items-center hover-me">
                        <span class="me-3 hover:text-[#F5CA56]"
                          >View Details</span
                        >
                        <img src="../assets/svg/move-right-yellow.svg" />
                      </button>
                    </p>
                  </div>
                </div>

                <div class="flex justify-between w-9/12 my-9">
                  <img
                    src="../assets/sponsor1.png"
                    class="sponsor-logos cursor-pointer"
                  />
                  <img
    ...
    <section>
      <div class="py-[3rem]">
        <div class="container mx-auto px-3">
          <div class="grid grid-cols-1 gap-1 justify-items-stretch">
            <div class="flex flex-col">
              <div class="justify-self-start">
                <h2 class="text-5xl font-extrabold">
                  We Are <span class="text-[#F5CA56]">Loaft</span>
                  <br class="d-none lg:d-block" />Top Services that we offer
                </h2>
                <p class="text-xl mt-6">
                  If you are looking at blank cassettes on the web, you may be
                  very <br />confused at the difference in price.
                ...
                <p class="mt-5">
                  <img
                    src="../assets/svg/move-right (1).svg"
                    class="hover-me"
                  />
                </p>
              </div>
          ...
          >
            ...
            <div class="flex flex-col">
              ...
              >
                <h3 class="font-extrabold text-3xl">Smart Kitchen Setup</h3>
                <p class="text-[#8C8C8C]">
                  If you are looking at blank cassettes on the web, you may be
                  very confused at the difference in price. You may see some for
                  as low as $.17 each. You may be saying to yourself.
                ...
                <p class="mt-8 text-xl">
                  <button type="submit" class="flex items-center hover-me">
                    <span class="me-3 hover:text-[#F5CA56]">View Details</span>
                    <img src="../assets/svg/move-right-yellow.svg" />
                  </button>
                </p>
              </div>
              <div
                class="lg:w-3/4 ms-0 lg:ms-8 my-6 border border-[#f3f3f3] p-3 border-t-0 border-b-0 border-s-0 border-e-0"
              >
                <h3 class="font-extrabold text-3xl">Smart Kitchen Setup</h3>
                <p class="text-[#8C8C8C]">
                  If you are looking at blank cassettes on the web, you may be
              ...
              <div
                class="lg:w-3/4 my-6 border border-[#f3f3f3] p-3 border-b-0 border-s-0 border-e-0"
              >
                <h3 class="font-extrabold text-3xl">Smart Kitchen Setup</h3>
                <p class="text-[#8C8C8C]">
                  If you are looking at blank cassettes on the web, you may be
          ...
          >
            ...
            <div class="flex flex-col">
              ...
              <div class="mt-5 grid grid-cols-3">
                <div
                  class="card p-3 m-2 flex justify-center items-center flex-col"
                >
                  <img
                  ...
                  <p class="font-black text-3xl text-center mt-4">
                    {{ projectDoneStart }}
                  </p>
        ...
        <div class="container mx-auto px-3">
          ...
          >
            <div class="flex flex-col self-center">
              <div class="justify-self-start">
                <h2 class="text-5xl font-extrabold">
                  We Are <span class="text-[#F5CA56]">Loaft</span><br/> What our
                  Priority <br/> <span class="text-[#F5CA56]">Client's Says</span>
                </h2>
                <p class="text-xl mt-6">
                  If you are looking at blank cassettes on the web, you may be
                  very <br />confused at the difference in price.
                  ...
                  <carousel :items-to-show="1" wrapAround :autoplay="3000" >
                    <slide v-for="slide in allData.items" :key="slide.id">
                      ...
                      <div class="carousel__item flex my-5 ">
                        ...
                        <div class="ms-3">
                          <p class="font-extrabold text-start">Victory Ndu</p>
                          <p class="text-gray-500 text-start">Managing Director</p>
                       ...
                       <!-- <navigation>
                        <template #next>
                          <div class="carousel__next">
                            <img src="../assets/svg/move-right.svg" class="carousel__icon" />
                          </div>
                        </template>
                        <template #prev>
                          <div class="carousel__prev relative top-[-5rem]">
                            <img src="../assets/svg/move-right.svg"  class="carousel__icon"/>
                          </div>
                        </template>
                      </navigation>  -->
...
const allData = reactive({
    items: [
    { id:  1, name: "I couldn't be happier with my recent purchase from this furniture website! The quality of the craftsmanship exceeded my expectations, and the customer service was exceptional. My new sofa has become the centerpiece of my living room, and I constantly receive compliments on its style and comfort." },
    { id:  2, name: "Shopping for furniture online can be daunting, but this website made the process so easy and enjoyable. From browsing their wide selection to receiving my order ahead of schedule, every step was seamless. " },
    { id:  3, name: "I've been searching for the perfect bedroom set for months, and I finally found it on this website! The variety of styles and finishes made it easy to find something that matched my taste and budget." },
    { id:  4, name: "As an interior designer, I'm always on the lookout for unique pieces to elevate my clients' spaces, and this website has become my go-to resource. The curated collection of furniture and decor makes it easy to find pieces that fit any design aesthetic, from modern and minimalist to classic and traditional." },
