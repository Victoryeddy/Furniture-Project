<template>
  <div class="right-0 bg-[#f9f9ff] w-[20%] p-5  z-30 top-0 fixed h-full">
     <ul class="mt-[8rem] p-5 text-center">
      ...
      <li class="my-4"><NuxtLink to="#" class="font-extrabold hover:border-b-2 border-[#A1621F]">Service</NuxtLink></li>
